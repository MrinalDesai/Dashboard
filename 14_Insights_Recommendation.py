...
st.write("""\n One can witness the amount of strain that will be put on Govt resources
         ...
         \nIf Govt can’t find enough trained teachers then the next alternative is to make the 
         best we can with limited Trained Supply of Teachers.Merely recruiting more 
         teachers will put tremendous strain on govt Resources. A report titled ‘Involvement 
         of Teachers in Non-teaching Activities and its Effect on Education’ stated that 
         ...
         to the report, only 19.1 per cent of a teacher’s annual school hours is spent on 
         teaching activities. The remaining part of the teacher’s time goes in 42.6 per 
...
st.write("""\n✅Giving recognition to Online learning and Degrees and Certificates aquired through 
         online-mode, we can reduce the Burden on Teacher Resources as it would encourage people to pursue this mode of learning.

         \n✅Government should continue to invest in Digital Infrastructure as well as improve Broadband Connectivity.
